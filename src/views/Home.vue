...
<script>
    ...
    export default {
        ...
        created() {
            const _this = this
            axios.get('http://39.106.173.77:8182/phone/index').then(function (resp) {
        ...
        methods: {
            onClick(index) {
                const _this = this
                axios.get('http://39.106.173.77:8182/phone/findByCategoryType/' + this.categories[index].type).then(function (resp) {
